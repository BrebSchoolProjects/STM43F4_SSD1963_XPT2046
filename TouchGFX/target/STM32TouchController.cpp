...
#define GUI_WIDTH 	DISP_HOR_RESOLUTION
#define GUI_HEIGHT 	DISP_VER_RESOLUTION

//extern "C" {
//static void ConvXPTtoLCD(uint16_t *x, uint16_t *y)
//{
//	int16_t tx,ty;
...
bool STM32TouchController::sampleTouch(int32_t& x, int32_t& y)
{
	 ...
	 *
	 */
	static uint16_t prevx = 800; //GUI_WIDTH;
	static uint16_t prevy = 480; //GUI_HEIGHT;
	uint16_t intx, inty;
	xpt2046_read_position(&intx, &inty);
	if (intx != 0 && inty != 0) {
		x = intx;
		y = inty;
		return true;
